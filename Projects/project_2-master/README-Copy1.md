...
With these specific features that I chose for the regression model I hope that this model can be replicated and used as a tool to evaluate a real estate invesment deal. This regression model would be good in predicting the price with an error of around $30,000. This is to pass the baseline requirement for a potential investment. After the investors get the list of houses from this model they will have to further evalutate the specific property to determine if this is a potential investment or not.
