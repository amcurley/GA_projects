...
Write a function that finds the n adjacent digits in a given number that have the greatest product. Use this function to find the thirteen adjacent digits in the above 1000-digit number that have the greatest product. What is the value of this product?
...
## Note
Coding question from this [source](https://projecteuler.net/).
